...
<div>
 ...
 autocomplete="tel"
 />
 <x-input-error :messages="$errors->get('phone')" class="mt2" />
</div>
<div class="form-group row">
 <label for="address" class="col-md-4 col-form-label textmd-right">
 {{ __('Address') }}
 </label>
 <div class="col-md-6">
...
<div class="form-group row">
 <label for="phone_number" class="col-md-4 col-form-label
text-md-right">
 {{ __('Phone Number') }}
 </label>
 <div class="col-md-6">
...
focus:ring-offset-2 focus:ring-indigo-500" href="{{
route('login') }}">
