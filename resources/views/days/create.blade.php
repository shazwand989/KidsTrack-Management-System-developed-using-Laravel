...
<div class="create-day-page">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-1">Add New Academic Day</h3>
                        <p class="mb-0">Create a new day record for timetable scheduling.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card day-form-card">
        <div class="card-header">
            ...
            <p class="day-form-subtitle">Please enter the day name before saving the record.</p>
        </div>
 ...
 <div class="col-md-6 mb-4">
    ...
    <div class="input-icon-wrapper">
        <select
            ...
            <option value="Friday" {{ old('day_name') == 'Friday' ? 'selected' : '' }}>Friday</option>
    ...
    @enderror
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-save-day">
