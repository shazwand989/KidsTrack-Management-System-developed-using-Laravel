...
@section('page-title', 'Create Lecturer Group')

@section('content')

<style>
    .create-lecturer-group-page {
        padding-top: 5px;
    }
...
<div class="create-lecturer-group-page">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-1">Add New Class Group</h3>
                        <p class="mb-0">Create a new Class group record by entering the group name and part.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card lecturer-group-form-card">
        <div class="card-header">
            ...
            <p class="lecturer-group-form-subtitle">Please complete all required fields before saving the group record.</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('lecturer-groups.store') }}" method="POST">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-save-lecturer-group">
