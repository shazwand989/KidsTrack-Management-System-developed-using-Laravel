...
<div class="create-hall-page">
            ...
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    <div class="hall-form-icon">
                        <i class="material-symbols-rounded">add_business</i>
                    </div>

                    <div>
                        <h3 class="mb-1">Add New Hall</h3>
                        <p class="mb-0">Create a new lecture hall record by entering the hall name and location.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card hall-form-card">
        <div class="card-header">
            ...
            <p class="hall-form-subtitle">Please complete all required fields before saving the hall record.</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('halls.store') }}" method="POST">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-save-hall">
