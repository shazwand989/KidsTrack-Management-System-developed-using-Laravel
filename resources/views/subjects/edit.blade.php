...
<div class="edit-subject-page">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h3 class="mb-1">Edit Subject Record</h3>
                        <p class="mb-0">Update subject details and assigned lecturer information in the system.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card subject-form-card">
        <div class="card-header">
            ...
            <p class="subject-form-subtitle">Modify the fields below and save the updated subject record.</p>
        </div>
        ...
        <div class="card-body">
            <form action="{{ route('subjects.update', $subject->id) }}" method="POST">
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-update-subject">
