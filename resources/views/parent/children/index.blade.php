    ...
    <div style="overflow-x:auto;">
        <table class="child-table">
            ...
            <tbody>
                ...
                <tr onclick="location.href='{{ route('parent.children.show', hash_id($child->id)) }}'">
                    ...
                    <td><a href="{{ route('parent.children.show', hash_id($child->id)) }}" class="btn-view"><i class="material-symbols-rounded" style="font-size:14px;">visibility</i> View</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
