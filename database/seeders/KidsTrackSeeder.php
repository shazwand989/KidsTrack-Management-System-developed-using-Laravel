...
class KidsTrackSeeder extends Seeder
{
    ...
    private function seedGuardians(): void
    {
        DB::table('guardians')->insert([
            ['id' => 1, 'parent_id' => 1, 'user_id' => 13, 'name' => 'Zulkifli bin Omar (Atuk)',     'age' => '62', 'phone' => '011-9945 8141', 'address' => "Kampung Batu 11, 85200 Segamat, Johor",      'photo' => null, 'type' => 'guardian', 'verified' => true,  'emergency' => true,  'created_at' => '2026-03-10 14:10:00', 'updated_at' => '2026-03-10 14:10:00'],
    ...
    private function seedChildren(): void
    {
        DB::table('children')->insert([
            ...
            ['id' => 1,  'name' => 'Adam bin Mohd Hafiz',         'age' => 2, 'ic_number' => '200704-01-0123', 'dob' => '2024-07-04', 'address' => 'Kampung Batu 11, Jementah, 85200 Segamat, Johor', 'photo' => null, 'qr_code' => 'KID-0001', 'qr_code_url' => null, 'nursery_type' => 'full_day', 'parent_id' => 1, 'second_parent_id' => 1, 'guardian_id' => 1, 'medical_notes' => null, 'dietary' => 'Tidak boleh makan makanan laut (alahan)', 'is_active' => true, 'enrollment_date' => '2026-03-15', 'classroom_id' => 1, 'created_at' => '2026-03-15 08:00:00', 'updated_at' => '2026-03-15 08:00:00'],
            ['id' => 2,  'name' => 'Aisyah binti Mohd Hafiz',      'age' => 1, 'ic_number' => '200805-01-0456', 'dob' => '2025-08-05', 'address' => 'Kampung Batu 11, Jementah, 85200 Segamat, Johor', 'photo' => null, 'qr_code' => 'KID-0002', 'qr_code_url' => null, 'nursery_type' => 'full_day', 'parent_id' => 1, 'second_parent_id' => 1, 'guardian_id' => 1, 'medical_notes' => null, 'dietary' => null, 'is_active' => true, 'enrollment_date' => '2026-06-01', 'classroom_id' => 1, 'created_at' => '2026-06-01 08:00:00', 'updated_at' => '2026-06-01 08:00:00'],
            // Family 2: Rosnani & Azman — 1 kid
            ['id' => 3,  'name' => 'Aqilah binti Azman',           'age' => 2, 'ic_number' => '200706-01-0789', 'dob' => '2024-06-06', 'address' => 'Taman Gemilang, 85000 Segamat, Johor',            'photo' => null, 'qr_code' => 'KID-0003', 'qr_code_url' => null, 'nursery_type' => 'half_day', 'parent_id' => 3, 'second_parent_id' => 2, 'guardian_id' => 2, 'medical_notes' => 'Asma ringan (inhaler di dalam beg)', 'dietary' => null, 'is_active' => true, 'enrollment_date' => '2026-04-10', 'classroom_id' => 1, 'created_at' => '2026-04-10 08:00:00', 'updated_at' => '2026-04-10 08:00:00'],
            // Family 3: Siti Hajar & Farid — 2 kids
            ['id' => 4,  'name' => 'Danish bin Farid',             'age' => 2, 'ic_number' => '200708-01-0321', 'dob' => '2024-08-08', 'address' => 'Taman Mewah, 85000 Segamat, Johor',               'photo' => null, 'qr_code' => 'KID-0004', 'qr_code_url' => null, 'nursery_type' => 'full_day', 'parent_id' => 5, 'second_parent_id' => 3, 'guardian_id' => 3, 'medical_notes' => null, 'dietary' => null, 'is_active' => true, 'enrollment_date' => '2026-05-01', 'classroom_id' => 1, 'created_at' => '2026-05-01 08:00:00', 'updated_at' => '2026-05-01 08:00:00'],
            ['id' => 5,  'name' => 'Damia binti Farid',            'age' => 1, 'ic_number' => '200910-01-0654', 'dob' => '2025-10-09', 'address' => 'Taman Mewah, 85000 Segamat, Johor',               'photo' => null, 'qr_code' => 'KID-0005', 'qr_code_url' => null, 'nursery_type' => 'afternoon', 'parent_id' => 5, 'second_parent_id' => 3, 'guardian_id' => 3, 'medical_notes' => null, 'dietary' => null, 'is_active' => true, 'enrollment_date' => '2026-06-15', 'classroom_id' => 1, 'created_at' => '2026-06-15 08:00:00', 'updated_at' => '2026-06-15 08:00:00'],
            // Family 4: Noraini & Rashid — 2 kids
            ['id' => 6,  'name' => 'Farah binti Rashid',           'age' => 2, 'ic_number' => '200709-01-0987', 'dob' => '2024-09-09', 'address' => 'Kampung Tengah, 85200 Segamat, Johor',             'photo' => null, 'qr_code' => 'KID-0006', 'qr_code_url' => null, 'nursery_type' => 'full_day', 'parent_id' => 7, 'second_parent_id' => 4, 'guardian_id' => 4, 'medical_notes' => null, 'dietary' => 'Tidak boleh minum susu lembu (Lactose intolerant)', 'is_active' => true, 'enrollment_date' => '2026-05-15', 'classroom_id' => 1, 'created_at' => '2026-05-15 08:00:00', 'updated_at' => '2026-05-15 08:00:00'],
            ['id' => 7,  'name' => 'Haris bin Rashid',             'age' => 1, 'ic_number' => '201001-01-0432', 'dob' => '2025-10-10', 'address' => 'Kampung Tengah, 85200 Segamat, Johor',             'photo' => null, 'qr_code' => 'KID-0007', 'qr_code_url' => null, 'nursery_type' => 'flexible', 'parent_id' => 7, 'second_parent_id' => 4, 'guardian_id' => 4, 'medical_notes' => null, 'dietary' => 'Vegetarian', 'is_active' => true, 'enrollment_date' => '2026-07-01', 'classroom_id' => 1, 'created_at' => '2026-07-01 08:00:00', 'updated_at' => '2026-07-01 08:00:00'],
